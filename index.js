...
bot.on("ready", async () => {
    ...
    bot.user.setActivity("swagns666! | prefix ~", {type: "LISTENING"});
...
bot.on("message", async message => {
    ...
    if(cmd === `${prefix}kick`){
      ...
      console.log("Someone just attempted to kick!")
    ...
    if(cmd === `${prefix}ban`){
        ...
        console.log("Someone just attempted to ban!")
    ...
    if(cmd === `${prefix}report`){
      ...
      console.log("Someone just attempted to report!")
    ...
    if(cmd === `${prefix}serverinfo`){
        ...
        console.log(cmd.author.username + "just asked for the info of the server")
    ...
    if(cmd === `${prefix}botinfo`){
        ...
        console.log("Someone just attempted to hijack my info!")
